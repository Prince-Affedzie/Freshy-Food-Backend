...
const productSchema = new mongoose.Schema(
  {
    ...
    category: {
      ...
      enum: [
        ...
        "sports and fitness",
        "accessories",
        "food and drinks","tutoring and education",
        "tickets and events","events and catering",
        'transport and logistics',"photography and media",
        "services","graphic-design-printing",
        "groceries","repair and services",
        "other","accommodation and housing",
      ],
    },
